...
## This app's role: Moving Motivators — Reach

The card exercise breaks when teams are distributed; being the version
practitioners link to wins the community.

**App-specific outcome (from the previous goal framing, still the concrete
